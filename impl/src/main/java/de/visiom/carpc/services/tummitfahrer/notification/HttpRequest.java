...
public class HttpRequest {
	...
	* @param url   The URL where the post request needs to be sent
	...
	public String sendDELETERequest(String url, String urlParameters) throws Exception {	 		
		URL obj = new URL(url);		
		HttpURLConnection con = (HttpURLConnection) obj.openConnection();
	...
	public String sendPOSTRequest(String url, String urlParameters) throws Exception {	 		
		URL obj = new URL(url);		
		HttpURLConnection con = (HttpURLConnection) obj.openConnection();
